...
export const HttpProblemType = irreducible('HttpProblemType', x => (x instanceof HttpProblem) || (x && x.name && x.name === HttpProblem.name && '$context' in x && URIValue.is(x.$context) && $context.equals(x.$context)))
